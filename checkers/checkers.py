...
import pygame
import os
from CHECKERS.constants import WIDTH, HEIGHT, RED, WHITE, SQUARE_SIZE, GREY, Rsound, Usound
...
checkersbg = pygame.transform.scale(pygame.image.load(os.path.join("checkers", "CHECKERS", "checkersbg.png")), (800, 800))
...
def menu_screen(win):
    ...
    while run:
        ...
        title = font.render("Click to play Checkers", 1, WHITE)
